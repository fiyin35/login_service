...
export const signin = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({email: existingUser.email, id: existingUser._id}, 'delete', { expiresIn: "1h" });
...
export const signup = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({email: result.email, id: result._id}, 'delete', { expiresIn: "1h" });
